  ...
  return (
    <div className="min-h-screen bg-[#020202] flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center p-4 pt-24 pb-12 relative z-10">
        ...
        >
          <Suspense fallback={
            <div className="glass-card rounded-3xl p-12 border border-white/20 flex flex-col items-center justify-center backdrop-blur-3xl shadow-[0_0_100px_rgba(0,0,0,0.8)]">

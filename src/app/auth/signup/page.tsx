  ...
  return (
    <div className="min-h-screen bg-[#020202] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-[-30%] right-[-20%] w-[120%] h-[120%] bg-secondary-500/30 rounded-full blur-[250px]" />
        <div className="absolute bottom-[-30%] left-[-20%] w-[120%] h-[120%] bg-primary-500/30 rounded-full blur-[250px]" />
          ...
          <div className="bg-[#101012] rounded-3xl p-8 border border-white/20 relative overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] ring-1 ring-white/10">
            ...
            <div className="relative z-10">
              <div className="flex justify-center mb-8">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-secondary-500/20 to-primary-500/20 flex items-center justify-center border border-white/10 shadow-[0_0_30px_rgba(168,85,247,0.15)]">
                  <Gem className="w-8 h-8 text-secondary-400" aria-hidden="true" />
                </div>
              </div>
              ...
              <p className="text-gray-400 text-center text-sm mb-8">
                Join TopUp Hub for fast, secure game credits.
              </p>
              ...
              {success ? (
                <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex flex-col items-center text-center gap-4 animate-in fade-in zoom-in duration-500">
                  ...
                  <Button variant="outline" className="mt-2" onClick={() => router.push("/auth/login")} fullWidth>
                    Back to Login
                  </Button>
                </div>
              ) : (
                <>
                  <form onSubmit={handleSignup} className="flex flex-col gap-5">
                    ...
                    <Button type="submit" variant="secondary" fullWidth loading={loading} className="mt-2">
                      Create Account
                    </Button>
                  </form>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-3">
                    <Button type="button" variant="outline" onClick={handleGoogleSignup} className="px-0">
                    ...
                    <Button type="button" variant="outline" onClick={handleFacebookSignup} className="px-0">
                  ...
                  <p className="text-center text-sm text-gray-400 mt-8">
                    ...
                    <Link href="/auth/login" className="text-secondary-400 hover:text-secondary-300 font-semibold transition-colors hover:underline">
                      Sign in
                    </Link>
                  </p>
                </>
